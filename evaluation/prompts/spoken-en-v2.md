# Spoken English conversion prompt v2
...
8. `chinese_meaning` 表示该英文句子对应的简明中文含义，不要增加教学解释。
9. 只输出一个有效 JSON 对象，不输出 Markdown、代码围栏、前言或解释。
...
- `metadata.prompt_version`：固定为 `spoken-en-v2`。
